...
<script src="<?php echo e(asset('dist/js/app.init.horizontal.js')); ?>"></script>
<script src="<?php echo e(asset('dist/js/app-style-switcher.horizontal.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/extra-libs/horizontal-timeline/horizontal-timeline.js')); ?>"></script>
...
<script src="<?php echo e(asset('dist/js/pages/datatable/datatable-advanced.init.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/libs/echarts/dist/echarts-en.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/libs/flot/excanvas.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/libs/flot/jquery.flot.js')); ?>"></script>
<script src="<?php echo e(asset('assets/libs/jquery.flot.tooltip/js/jquery.flot.tooltip.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('dist/js/pages/widget/widget-charts.js')); ?>"></script>
<script src="<?php echo e(asset('assets/libs/magnific-popup/dist/jquery.magnific-popup.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/libs/magnific-popup/meg.init.js')); ?>"></script>
<!-- ============================================================== -->
<!--  authentication  js -->
<!-- ============================================================== -->
...
<!--  chatbot  js -->
<!-- ============================================================== -->
<script src="<?php echo e(asset('assets/js/script_chat.js')); ?>"></script>
<!-- ============================================================== -->
<!-- This page plugin js -->
<!-- ============================================================== -->
<script>
...
<?php /**PATH D:\Projects\مشروع الكلية\project code\f.s.s.r\resources\views/layout/scripts.blade.php ENDPATH**/ ?>