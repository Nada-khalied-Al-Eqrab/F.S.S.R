                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h1 class="font-light text-right">17000</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h1 class="font-light text-right">1000</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h1 class="font-light text-right">150</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="font-16 m-b-5"> اجمالى مواد الدبلومات </p>
                                </div>
                                <div class="ml-auto">
                                    <h1 class="font-light text-right">112</h1>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                                ...
                                <div id="myCarousel3" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="table-st.html" style="color: white;">
                                                        عرض
                                                        بيانات الطلاب
                                                    </a></button>
                                            </div>
                                        ...
                                        <div class="carousel-item flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="table-dr.html" style="color: white;">
                                                        عرض
                                                        بيانات الدكاترة
                                                    </a> </button>
                                            </div>
                                ...
                                <div id="myCarousel3" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="form-study-schedule.html" style="color: white;">
                                                        اضافة
                                                        جدول
                                                    </a> </button>
                                            </div>
                                        ...
                                        <div class="carousel-item flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="form-exam-schedule.html" style="color: white;">
                                                        اضافة جدول
                                                    </a></button>
                                            </div>
                                        </div>
                                ...
                                <div id="myCarousel3" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="form-file.html" style="color: white;">
                                                        اضف ملف الان
                                                    </a> </button>
                                            </div>
                                        </div>
                                        <div class="carousel-item flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="users_form.html" style="color: white;">
                                                        اضافة دكتور
                                                    </a> </button>
                                            </div>
                                        </div>
                                ...
                                <div id="myCarousel3" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="form-st.html" style="color: white;">
                                                        اطلع الان
                                                    </a></button>
                                            </div>
                                        </div>
                                        <div class="carousel-item flex-column">
                                            ...
                                            <div>
                                                <button class="btn btn-secondary b-0 waves-effect waves-light m-t-15">
                                                    <a href="form-dr.html" style="color: white;">
                                                        اطلع الان
                                                    </a> </button>
                                            </div>
                                        </div>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body" style="text-align: center;">
                        <div class="row">
                            <div class="col-lg-3 col-md-2"><br><img src="{{ asset("assets/images/platform.png") }}" class="img-fluid"
                                    style="width: 600; height:200px;justify-content: center;" />
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card  card-hover">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class=" btn btn-secondary" href="form-dr.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة دكتور
                                    </a>
                                    <a class=" btn btn-secondary" href="form-st.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة طالب
                                    </a>
                                    <a class=" btn btn-secondary" href="form-em.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة موظف
                                    </a>
                                    <br>
                                    <br>
                                    <a class=" btn btn-secondary" href="form-dr-subj.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة دكتور لمادة دراسية
                                    </a>

                                    <a class=" btn btn-secondary" href="form-subj-contant.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card  card-hover">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class=" btn btn-secondary" href="form-add-subj.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة مادة دراسية
                                    </a>
                                    <a class=" btn btn-secondary" href="form-add-diploma.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة  دبلومة
                                    </a>
                                    <a class=" btn btn-secondary" href="form-place.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة اماكن القاعات و المعامل
                                    </a>
                                    <a class=" btn btn-secondary" href="form-file.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة ملف
                                    </a>
                                    <br>
                                    <br>
                                    <a class=" btn btn-secondary" href="form-study-schedule.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة جدول دراسى
                                    </a>
                                    <a class=" btn btn-secondary" href="form-exam-schedule.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        اضافة جدول امتحانات
                                    </a>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card  card-hover">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class=" btn btn-secondary" href="table-dr.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات الدكتور
                                    </a>
                                    <a class=" btn btn-secondary" href="table-st.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات الطالب
                                    </a>
                                    <br><br>
                                    <a class=" btn btn-secondary" href="table-em.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات الموظف
                                    </a>
                                    <a class=" btn btn-secondary" href="table-subj-study.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card  card-hover">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class=" btn btn-secondary" href="table-subj.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات المواد الدراسية
                                    </a>
                                    <a class=" btn btn-secondary" href="table-diploma.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات  الدبلومات
                                    </a>
                                    <a class=" btn btn-secondary" href="table-file.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات الملفات
                                    </a>
                                    <a class=" btn btn-secondary" href="table-study.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات الجداول الدراسية
                                    </a>
                                    <br><br>
                                    <a class=" btn btn-secondary" href="table-ex.html"> <i
                                            class="mdi mdi-cards-variant"></i>
                                        بيانات جداول الامتحانات
                                    </a>
                                    <a class=" btn btn-secondary" href="table-places.html"> <i
                                            class="mdi mdi-cards-variant"></i>
