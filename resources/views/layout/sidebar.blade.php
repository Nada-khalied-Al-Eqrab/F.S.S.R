        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">لوحة
                        التحكم</span></li>
                <li class="sidebar-item"> <a class="sidebar-link  waves-effect waves-dark" href="index.html"
                        aria-expanded="false"><i class="ti-home"></i><span class="hide-menu">المنصة
                            لدراسية</span></a></li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item"><a href="Subj-registration.html" class="sidebar-link"><i
                                    class="mdi mdi-lightbulb-on-outline"></i><span class="hide-menu">كيفية تسجيل
                                    المواد</span></a></li>
                        <li class="sidebar-item"><a href="iframe-show-file.html" class="sidebar-link"><i
                                    class="mdi mdi-cards-variant"></i> <span class="hide-menu"> دليل
                                    الطالب</span></a></li>
                        <li class="sidebar-item"><a href="StudyPlan.html" class="sidebar-link"><i
                                    class="mdi mdi-clock-end"></i><span class="hide-menu"> خطة الدراسة
                                </span></a></li>
                        <li class="sidebar-item"><a href="Graduation-projects.html" class="sidebar-link"><i
                ...
                <li class="sidebar-item mega-dropdown"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item"><a href="CS-subj.html" class="sidebar-link"><i
                                    class="mdi mdi-library"></i><span class="hide-menu"> مواد دبلوم علوم
                                    الحاسب</span></a></li>
                        <li class="sidebar-item"><a href="SIT-subj.html" class="sidebar-link"><i
                                    class="mdi mdi-library"></i><span class="hide-menu"> مواد دبلوم نظم و
                                    تكنولوجيا المعلومات</span></a></li>
                        <li class="sidebar-item"><a href="STAT-subj.html" class="sidebar-link"><i
                                    class="mdi mdi-library"></i><span class="hide-menu"> مواد دبلوم
                                    الاحصاء</span></a></li>
                        <li class="sidebar-item"><a href="BD-subj.html" class="sidebar-link"><i
                                    class="mdi mdi-library"></i><span class="hide-menu"> مواد دبلوم الاحصاء
                                    الحيوى و السكانى</span></a></li>
                        <li class="sidebar-item"><a href="OR-subj.html" class="sidebar-link"><i
                                    class="mdi mdi-library"></i><span class="hide-menu"> مواد دبلوم بحوث
                                    العمليات</span></a></li>
                        <li class="sidebar-item"><a href="OM-subj.html" class="sidebar-link"><i
                                    class="mdi mdi-library"></i><span class="hide-menu"> مواد دبلوم ادارة
                                    العمليات</span></a></li>
                    </ul>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                ...
                <li class="sidebar-item "> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item"><a href="authentication-login.html" class="sidebar-link"><i
                                    class="mdi mdi-account-key"></i><span class="hide-menu"> تسجيل خروج
                                </span></a></li>
                        <li class="sidebar-item"><a href="authentication-register.html" class="sidebar-link"><i
                                    class="mdi mdi-account-plus"></i><span class="hide-menu"> انشاء
                                    حساب</span></a></li>
                        <li class="sidebar-item"><a href="authentication-recover-password.html"
                                class="sidebar-link"><i class="mdi mdi-account-edit"></i> <span class="hide-menu">
