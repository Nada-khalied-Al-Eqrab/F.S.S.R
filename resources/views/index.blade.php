                                        ...
                                        <table class="table v-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ asset("assets/FSSR_files/StudentGuide.pdf") }}" class="link"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ asset("assets/FSSR_files/لائحة-علوم-البيانات.pdf") }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ asset("assets/FSSR_files/CairoUnivStud_Guide0.pdf") }}"
                                                            class="link" download><i class="ti-download"></i></a>
                                                    </td>
                                                </tr>
                                                   {{-- هيتم تكرارها بال forech --}}
                                ...
                                <div class="comment-widgets scrollable" style="height:430px;">
                                    ...
                                    <div class="d-flex flex-row comment-row">
                                        <div class="comment-text w-100">
                                            <div class="p-2">
                                                <img src="{{ asset("assets/images/diploma/subj/main_subj.jpg") }}" alt="user"
                            ...
                            <div class="card" style="justify-content: center;text-align: center;">
                                ...
                                <div class="comment-widgets scrollable" style="height:430px;">
                                    ...
                                    <div class="d-flex flex-row comment-row">
                                        <div class="comment-text w-100">
                                            <div class="p-2">
                                                <img src="{{ asset("assets/images/diploma/subj/General/AS500.png") }}" alt="user"
                                    ...
                                    <div class="d-flex flex-row comment-row m-t-0">
                                        <div class="comment-text w-100">
                                            <div class="p-2">
                                                <img src="{{ asset("assets/images/diploma/subj/General/MS500.png") }}" alt="user"
                                                    width="50" height="50" class="rounded-circle">
                                            </div>
                                            <h6 class="font-medium"><strong> طرق رياضية </strong></h6>
                                            <span class="m-b-15 d-block">مادة أساسية تهدف إلى إكساب الطلاب
                                    ...
                                    <div class="d-flex flex-row comment-row">
                                        <div class="comment-text active w-100">
                                            <div class="p-2">
                                                <img src="{{ asset("assets/images/diploma/subj/General/DB500.png") }}" alt="user"
                                                    width="50" height="50" class="rounded-circle">
                                            </div>
                                            <h6 class="font-medium"> <strong> مقدمة فى الاحصاء الحيوى و
                                                    السكانى</strong></h6>
                                    ...
                                    <div class="d-flex flex-row comment-row">
                                        ...
                                        <div class="comment-text w-100">
                                            <div class="p-2">
                                                <img src="{{ asset("assets/images/diploma/subj/General/CS500.png") }}" alt="user"
                                                    width="50" height="50" class="rounded-circle">
                                            </div>
                                            <h6 class="font-medium"> <strong> مقدمة فى علوم لحاسب</strong></h6>
                                            <span class="m-b-15 d-block">مقرر تعريفي يهدف إلى تزويد الطلاب
                                    ...
                                    <div class="d-flex flex-row comment-row m-t-0">
                                        <div class="comment-text w-100">
                                            <div class="p-2">
                                                <img src="{{ asset("assets/images/diploma/subj/General/OR500.png") }}" alt="user"
                                                    width="50" height="50" class="rounded-circle">
                                            </div>
                                            <h6 class="font-medium"><strong>مقدمة فى بحوث العمليات</strong></h6>
                                            <span class="m-b-15 d-block">مقرر يوضح مبادئ وأساليب بحوث العمليات
